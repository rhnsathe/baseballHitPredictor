...
from model_utils import UTILS_PATH, NN_MODEL_PATH

def train_and_save():
    if os.path.exists(UTILS_PATH) and os.path.exists(NN_MODEL_PATH):
    ...
    print("Saved NN model to", NN_MODEL_PATH, "and utils to", UTILS_PATH)
